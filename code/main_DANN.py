...
def main():
    ...
    for i in range(sub_num):
        print('Test ', i)
        acc_s[i], acc_t[i] = classify(leave_one_num = i)
...
if __name__ == '__main__':
    ...
    # set eval_only to False to train your network
    ...
    # acc_DANN_uci = main()
    # np.savetxt("../1-results/acc_DANN_all_sensor_uci_souce_only.csv",
    #               acc_DANN_uci, delimiter=",")
    ...
    acc_DANN_nw = main()
    # np.savetxt("../1-results/acc_DANN_all_sensor_nw.csv",
    #           acc_DANN_nw, delimiter=",")

    # args.is_source_only = True

    # acc_DANN_nw = main()
    # np.savetxt("../1-results/acc_DANN_all_sensor_nw_souce_only.csv",
    #           acc_DANN_nw, delimiter=",")
    #
    # args.is_source_only = False
    # args.dataset = 'NW'
    ...
    # for i in range(6):
    #     args.sensor_num = i + 1
    #     acc_DANN_nw[2*i:2*(i+1), :] = main()
    # np.savetxt("../1-results/acc_DANN_compare_sensor_nw.csv",
    #           acc_DANN_nw, delimiter=",")
    #
    # args.dataset = 'UCI'
    #
    ...
    # for i in range(5):
    #     args.sensor_num = i + 1
    #     acc_DANN_uci[2*i:2*(i+1), :] = main()
    # np.savetxt("../1-results/acc_DANN_compare_sensor_uci.csv",
    #           acc_DANN_uci, delimiter=",")